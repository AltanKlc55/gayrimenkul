...
use Modules\Current\Entities\CurrentNote;
class CurrentNoteController extends Controller
{

    private $model;
    private $table = "current_note";
    private $page = "current::current_note";
    private $routename= "current_note";
    private $title;
    private $menu_id = 0;
    ...
    {
        $this->model = CurrentNote::class;
        $this->title = ___('Cari Notlar');
        $this->button = array(
//            array(
//                'title' => 'Yeni Ekle',
//                'id' => '',
...
//                array('current_type', 'current.current_type', '=', 'current_type.id','Left')
            ...
            'rows' => array(
                ...
                array('title' => 'Ekleyen','row' => 'person_id','type' => 'text'),
