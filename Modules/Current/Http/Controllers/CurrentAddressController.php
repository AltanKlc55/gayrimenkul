...
class CurrentAddressController extends Controller
{
    ...
    private $model;
    private $table = "current_address";
    private $page = "current::current_address";
    private $routename= "current_address";
    private $title;
    private $menu_id = 0;
...
//                array('current_type', 'current.current_type', '=', 'current_type.id','Left')
            ...
            'rows' => array(
                ...
                array('title' => 'Adres Adı','row' => 'title','type' => 'text'),
                array('title' => 'Ülke','row' => 'country','type' => 'text'),
                array('title' => 'Şehir No','row' => 'city','type' => 'text'),
                array('title' => 'İlçe','row' => 'district','type' => 'text'),
