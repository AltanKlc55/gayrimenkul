...
class CurrentTypeController extends Controller
{
    ...
    private $model;
    private $table = "current_type";
    private $page = "current::current_type";
    private $routename= "current_type";
    private $title;
    private $menu_id = 0;
    ...
    {
        $this->model = CurrentType::class;
        $this->title = ___('Cari Türleri');
        $this->button = array(
//            array(
//                'title' => 'Yeni Ekle',
//                'id' => '',
...
//                array('products_set', 'order.product', '=', 'products_set.id','Left')
            ...
            'rows' => array(
                ...
                array('title' => 'Cari Türü','row' => 'name','type' => 'text'),
