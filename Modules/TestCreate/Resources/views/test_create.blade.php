...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            <form action="{{route('test.store')}}" id="form" name="form" method="POST">
                @csrf
                                    ...
                                    <div class="form-group-wrapper mb-3"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group mb-3 col-md-6">
                                                ...
                                                <input type="text" required class="form-control max_point" value="">
                                            </div>
                                            ...
                                            <input type="hidden" required class="form-control" id="points_json" name="points_json"
                                                value="">
                                        </div>
