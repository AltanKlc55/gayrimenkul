...
class EmployeeLeaveController extends Controller
{
    ...
    private $page = "employee::employee_leave";
    private $routename= "employee_leave";
    private $title;
    private $menu_id = 0;
    ...
    {
        $this->model = EmployeeLeave::class;
        $this->title = ___('İzinler');
        $this->button = array(
//            array(
//                'title' => 'Yeni Ekle',
//                'id' => '',
...
//            ),
        ...
        $this->form  = array(
            ...
            array(
                ...
                'type' => 'select',
                'child' => 'name',
                'option' =>  array(['id' => 0,'name' => 'Gün'],['id' => 1,'name' => 'Saat']),
                'class' => 'select2',
                'grid' => 'col-md-3',
                'id' => '',
                'json' => false,
            ...
            array(
                ...
                'type' => 'select',
                'child' => 'title',
                'option' =>  get_definitions('leave_type'),
                'class' => 'select2',
                'grid' => 'col-md-9',
                'id' => '',
                'json' => false,
...
//                array('products_set', 'order.product', '=', 'products_set.id','Left')
            ...
            'rows' => array(
                ...
                array('title' => 'Başlama Tarihi','row' => 'start_date','type' => 'date'),
                array('title' => 'Bitiş Tarihi','row' => 'end_date','type' => 'date'),
                array('title' => 'İzin Türü','row' => 'leave_type','type' => 'get_definition'),
                array('title' => 'İzin Süresi','row' => 'leave_day','type' => 'leaveday'),
    ...
    public function show(Request $request)
    {
        ...
        if ($lists) {
            foreach ($lists as $list) {
                ...
                $iViewInvoice = url('uploads/employee_file',$list['leave_file']);
                ...
                foreach ($this->datatable['rows'] as $item){
                    switch ($item['type']){
                        ...
                        case 'money':
                            ...
                            break;
                        case 'leaveday':
                            $status = ($list['type'] == 0) ? 'Gün' : 'Saat';
                            $row[] = $list[$item['row']].' '.$status;
                            break;
                        case 'multilang':
