    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                <form action="{{route('ilanlar.edit')}}" id="form" name="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="form-group mb-3 col-md-6">
                                        ...
                                        <input type="text" name="baslik" value="{{ $page['row']->name }}" id="baslik"
                                    ...
                                    <div class="form-group mb-3 col-md-6">
                                        ...
                                        <input type="text" name="fiyat" id="fiyat" value="{{$page['row']->price}}" required
                                    ...
                                    <div class="form-group mb-3 col-md-12">
                                        ...
                                        <textarea class="form-control" id="adress"
                                            name="adress">{{$page['row']->adress}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 col-md-12">
                                        ...
                                        <textarea id="ilan_icerik" name="ilan_icerik"
                                            class="tinymce">{{$page['row']->content}}</textarea>
                                    </div>
                                    <input hidden type="text" name="props" id="props"
                                        value='@json($page["row"]->property_properties)'>
                                </div>
    ...
    function showError(message) {
        ...
        <script>
            $(document).ready(function () {
                let selectedPricing = "{{ $page['row']->price_type }}";
