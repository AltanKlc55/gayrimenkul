                ...
                <div class="card-body">
                    <form method="POST" id="form" action="{{$page['action']}}" enctype="multipart/form-data">
                        ...
                        <x-forms.input
                                ...
                                filetype=""
                                attribute=""
                                entry="{{isset($row['title']) ?  $row['title'] : ''}}"
                        />
                        <x-forms.select
                                title="{{___('Distributor')}}"
                                name="distributor"
                                class="select2"
                                grid="col-md-3"
                                :options="$page['distributor']"
                                id=""
                                tags=""
                                child="username"
                                selected="{{isset($row['distributor']) ? $row['distributor'] : ''}}"
                                readonly=""
                                multiple=""
                                description=""
                                required=""
                        ...
                        <x-forms.select
                                ...
                                class="select2"
                                grid="col-md-3"
                                :options="$page['semester']"
                                child=""
                                id=""
                                tags=""
                                selected="{{isset($row['group']) ? $row['group'] : ''}}"
                                readonly=""
                                multiple=""
                                description=""
                                required=""
    ...
    @push('javascript')
        ...
        <script>
            ...
            $("#formchild").submit(function(e){
                ...
                $.ajax({
                    type: "post",
                    url: "{{route('productset.store_child')}}",
                    data : string,
                    dataType: 'json',
