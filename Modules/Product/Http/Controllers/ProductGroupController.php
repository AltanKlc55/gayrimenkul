...
class ProductGroupController extends Controller
{
    ...
    private $model;
    private $table = "products_group";
    private $page = "product::productgroup";
    private $routename= "productgroup";
    private $title;
    private $menu_id = 0;
...
//                array('products_set', 'order.product', '=', 'products_set.id','Left')
            ...
            'rows' => array(
                ...
                array('title' => 'Grup Adı','row' => 'name','type' => 'text'),
