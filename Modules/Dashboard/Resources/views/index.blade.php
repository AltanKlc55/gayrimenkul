                    ...
                    <div class="d-flex align-items-top">
                        ...
                        <div class="flex-fill">
                            <div class="d-flex mb-1 align-items-top justify-content-between">
                                <h5 class="fw-semibold mb-0 lh-1">{{$current_count->count}}</h5>
                            </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="d-flex align-items-top">
                        ...
                        <div class="flex-fill">
                            <div class="d-flex mb-1 align-items-top justify-content-between">
                                <h5 class="fw-semibold mb-0 lh-1">{{$product_count->count}}</h5>
                            </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="d-flex align-items-top">
                        ...
                        <div class="flex-fill">
                            <div class="d-flex mb-1 align-items-top justify-content-between">
                                <h5 class="fw-semibold mb-0 lh-1">{{$offer_count->count}}</h5>
                            </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body text-center">
                        ...
                        <a href="{{route('testcreate.create')}}"  style="width: 180px;"  class="btn btn-dark my-1 me-2">
                            <span class="bx bx-bar-chart-alt"></span> Yeni Soru Oluşturun
                        </a>

                        <a href="{{route('test.create')}}"  style="width: 180px;" class="btn btn-dark my-1 me-2">
