                                                        ...
                                                        <div class="form-style">
                                                            <div class="group-select">
                                                                <div class="nice-select" tabindex="0"><span
                                                                    ...
                                                                    <ul class="list">
                                                                        @foreach ($data['ozellikler'] as $o)
                                                                            <li data-value="{{ $o->id }}" class="option">
                                                                                {{ $o->name }}</li>
                                                                        @endforeach
                                                                    </ul>
                                                                </div>
                                            ...
                                            <a href="property-details-v1.html" class="images-group">
                                              <div class="images-style">
                                                  <img class="lazyload" data-src="{{ $ilan->images[0] ?? '' }}"
                                                      src="{{ $ilan->images[0] ?? '' }}" alt="img-property">
                                              </div>
                                            </a>
                                        </div>
                                        <div class="archive-bottom">
                                            <div class="content-top">
                                                <h6 class="text-capitalize"><a href="property-details-v1.html"
                                                        class="link text-line-clamp-1">{{ $ilan->ilan_adi }}</a></h6>
                                                <ul class="meta-list">
                                                <li class="item">
                                                ...
                                                <div class="location">
                                                    ...
                                                    <span class="text-line-clamp-1">{{ $ilan->adress }}</span>
                                                </div>
                                            </div>
