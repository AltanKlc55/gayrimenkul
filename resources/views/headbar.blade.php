            ...
            <div class="header-element">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        @if(auth('manager')->user()->image)
                            <div class="me-sm-2 me-0">
                              <!--  <img src="{{asset('uploads/manager/'.auth('manager')->user()->image)}}" alt="img" width="32" height="32" class="rounded-circle">  -->
                            </div>
                        @endif

                        <div class="d-sm-block d-none">
                            <p class="fw-semibold mb-0 lh-1">{{auth('manager')->user()->username}}</p>
                        </div>
                    </div>
                </a>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    ...
                    <li><a class="dropdown-item d-flex" href="{{route('logout')}}"><i class="ti ti-logout fs-18 me-2 op-7"></i>{{___('Log Out')}}</a></li>
                </ul>
            </div>
            <!-- End::header-element -->
