                        ...
                        <div class="footer-cl-1">
                          ...
                          <ul class="mt-12">
                            <li class="mt-12 d-flex align-items-center gap-8">
                                ...
                                <p class="text-white">{{$data['ayarlar'][1]->value}}</p>
                            </li>
                            <li class="mt-12 d-flex align-items-center gap-8">
                                <i class="icon icon-phone2 fs-20 text-variant-2"></i>
                                <a href="tel:1-333-345-6868" class="text-white caption-1">{{$data['ayarlar'][2]->value}}</a>
                            </li>
                            <li class="mt-12 d-flex align-items-center gap-8">
                                <i class="icon icon-mail fs-20 text-variant-2"></i>
                                <p class="text-white">{{$data['ayarlar'][3]->value}}</p>
                            </li>
                          </ul>
                        </div>
                      </div>
