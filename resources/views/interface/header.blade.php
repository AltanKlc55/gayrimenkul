                                            ...
                                            <nav class="main-menu show navbar-expand-md">
                                                <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                    <ul class="navigation clearfix">
                                                        <li><a href="{{route('interface.index')}}">Anasayfa</a></li>
                                                        <li><a href="{{route('interface.ilanlar')}}?status=sell">Satılık</a></li>
                                                        <li><a href="{{route('interface.ilanlar')}}?status=rental">Kiralık</a></li>
                                                        <li><a href="{{route('interface.projeler')}}">Projeler</a></li>
                                                        <li><a href="{{route('interface.about')}}">Hakkımızda</a></li>
                                                        <li><a href="{{route('interface.blogs')}}">Bloglar</a></li>
                                                        <li><a href="{{route('interface.contact')}}">İletişim</a></li>
                                                    </ul>
                                                </div>
                                            </nav>
                                    </div>
