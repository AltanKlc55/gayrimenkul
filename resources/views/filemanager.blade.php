...
<head>
    ...
    <base href="{{asset('public/fileman')}}/" />
    ...
    <tr>
        <td valign="top" class="pnlDirs" id="dirActions">
            ...
            <div id="pnlLoadingDirs">
                ...
                <img src="{{asset("public/fileman/images/loading.gif")}}" title="Loading directory tree, please wait...">
            </div>
            ...
            <div class="pnlFiles">
                <div class="scrollPane">
                    <div id="pnlLoading">
                        ...
                        <img src="{{asset("public/fileman/images/loading.gif")}}" title="Loading files, please wait...">
                    </div>
