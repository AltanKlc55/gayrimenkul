                                        ...
                                        <a href="property-details-v1.html" class="images-group">
                                            <div class="images-style">
                                              <img class="lazyload" data-src="<?php echo e($ilan->images[0] ?? ''); ?>"
                                                  src="<?php echo e($ilan->images[0] ?? ''); ?>" alt="img">
                                            </div>
                                            <div class="bottom">
        ...
        <div class="box-title text-center wow fadeInUp">
         ...
         <div class="wow fadeInUp" data-wow-delay=".2s">
            <div dir="ltr" class="swiper tf-sw-location" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="1"
                ...
                <?php $__currentLoopData = $data["projelerimiz"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="swiper-slide">
                      <div class="box-location">
                          <a href="projects/<?php echo e($prj->slug); ?>" class="image img-style">
                            <img style="height:350px;" class="lazyload" data-src="uploads/page/<?php echo e($prj->image); ?>"
                                src="uploads/page/<?php echo e($prj->image); ?>" alt="image-location">
                          </a>
                          <div class="content">
                              <div class="inner-left">
                                  <h6 class="title link"><?php echo e($prj->title); ?></h6>
                              </div>
                              <a href="projects/<?php echo e($prj->slug); ?>" class="box-icon line w-44 round"><i class="icon icon-arrow-right2"></i></a>
                          </div>
                      </div>
                  </div>
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="flat-section">
        <div class="container">
            ...
            <div class="tf-grid-layout md-col-3 wow fadeInUp" data-wow-delay=".2s">
                <?php $__currentLoopData = $data['hizmetlerimiz']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="box-service">
                        <div class="image">
                          <img style="height: 130px !important;" class="lazyload" data-src="uploads/page/<?php echo e($hiz->image); ?>" src="uploads/page/<?php echo e($hiz->image); ?>" alt="image-location">
                        </div>
                        <div class="content">
                          <h5 class="title"><?php echo e($hiz->name); ?></h5>
            ...
            <div dir="ltr" class="swiper tf-sw-latest wow fadeInUp" data-wow-delay=".2s" data-preview="3" data-tablet="2"
                ...
                <div class="swiper-wrapper">
                   <?php $__currentLoopData = $data['blog']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <a href="<?php echo e($blog->slug); ?>" class="flat-blog-item hover-img">
                            <div class="img-style">
                                <img class="lazyload" data-src="uploads/page/<?php echo e($blog->image); ?>" src="uploads/page/<?php echo e($blog->image); ?>"
                                    alt="img-blog">
                                <span class="date-post"><?php echo e($blog->created_at->format('d-m-Y')); ?></span>
                            </div>
                            <div class="content-box">
                                <div class="post-author">
                                    <span class="fw-6">Private Real Estate</span>
                                </div>
                                <h5 class="title link"><?php echo e($blog->name); ?></h5>
                            </div>
...
<?php echo $__env->make('interfacemaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\astok\Desktop\private_real_estate\resources\views/default.blade.php ENDPATH**/ ?>