                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul class="breadcrumb">
                            ...
                            <li class="text-white">/ Projeler</li>
                        ...
                        <div class="col-lg-8">
                            <div class="flat-blog-detail">
                                <div class="mb-30 pb-30 line-b">
                                    <h3 class="title fw-8"><?php echo e($data["sayfa"][0]->name); ?></h3>
                                    <ul class="meta-blog">
                                        <li class="item">
                                        ...
                                        <li class="item">
                                            ...
                                            <span class="text-variant-1"><?php echo e($data["sayfa"][0]->created_at->format('d-m-Y')); ?></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="pb-30 line-b">
                                <?php echo $data["sayfa"][0]->description; ?>
                        ...
                        <div class="col-lg-4">
                            <aside class="sidebar-blog fixed-sidebar">
                                <div class="widget-box recent">
                                    <h5 class="text-black-2 text-capitalize">Bloglar & Haberler</h5>
                                    <ul>
                                       <?php $__currentLoopData = $data['bloglar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php echo e(url('blog/'.$blg->slug)); ?>" class="recent-post-item not-overlay hover-img">
                                                <div class="img-style">
                                                    <img src="<?php echo e(asset('uploads/page/'.$blg->image)); ?>" alt="post-recent">
                                                </div>
                                                <div class="content">
                                                    <div class="title"><?php echo e($blg->name); ?></div>
                                                    <div class="subtitle">
                                                        ...
                                                        <span><?php echo e($blg->created_at->format('d-m-Y')); ?></span>                                                    
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
...
<?php echo $__env->make('interfacemaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\astok\Desktop\private_real_estate\resources\views/interface_pages/projectsdetail.blade.php ENDPATH**/ ?>