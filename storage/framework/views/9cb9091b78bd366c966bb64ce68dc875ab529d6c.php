...
<section class="flat-title-page" style="background-image: url(uploads/page/<?php echo e($data["sayfa"][0]->banner); ?>);">
            ...
            <section class="flat-section">
                <div class="container">
                    <div class="row">
                    <?php $__currentLoopData = $data['bloglar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                    
                        <div class="col-lg-4 col-md-6">
                            <a href="blogs/<?php echo e($prj->slug); ?>" class="flat-blog-item hover-img">
                                <div class="img-style">
...
<?php echo $__env->make('interfacemaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\astok\Desktop\private_real_estate\resources\views/interface_pages/blog.blade.php ENDPATH**/ ?>