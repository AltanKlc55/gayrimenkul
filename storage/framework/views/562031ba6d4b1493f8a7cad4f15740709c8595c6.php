                        ...
                        <div class="col-lg-4">
                            <aside class="sidebar-blog fixed-sidebar">
                                <div class="widget-box recent">
                                    ...
                                    <ul>
                                       <?php $__currentLoopData = $data['projeler']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php echo e(url('projects/'.$blg->slug)); ?>" class="recent-post-item not-overlay hover-img">
                                                <div class="img-style">
...
<?php echo $__env->make('interfacemaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\astok\Desktop\private_real_estate\resources\views/interface_pages/blogdetail.blade.php ENDPATH**/ ?>