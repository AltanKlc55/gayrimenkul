<footer class="footer">
                <div class="top-footer">
                  <div class="container">
                    <div class="content-footer-top">
                        <div class="footer-logo"><a href="index.html"><img src="../interface/images/logo/logow.png" alt="logo" width="166" height="48"></a></div>
                        <div class="wd-social">
                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-6">
                        <div class="footer-cl-1">
                          <p class="text-variant-2">Bizimle iletişime geçin</p>
                          <ul class="mt-12">
                            <li class="mt-12 d-flex align-items-center gap-8">
                                <i class="icon icon-mapPinLine fs-20 text-variant-2"></i>
                                <p class="text-white"><?php echo e($data['ayarlar'][1]->value); ?></p>
                            </li>
                            <li class="mt-12 d-flex align-items-center gap-8">
                                <i class="icon icon-phone2 fs-20 text-variant-2"></i>
                                <a href="tel:1-333-345-6868" class="text-white caption-1"><?php echo e($data['ayarlar'][2]->value); ?></a>
                            </li>
                            <li class="mt-12 d-flex align-items-center gap-8">
                                <i class="icon icon-mail fs-20 text-variant-2"></i>
                                <p class="text-white"><?php echo e($data['ayarlar'][3]->value); ?></p>
                            </li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-lg-2 col-md-6">
                        <div class="footer-cl-2 footer-col-block">
                            <div class="fw-7 text-white footer-heading-mobile">Menü</div>
                            <div class="tf-collapse-content">
                                <ul class="mt-10 navigation-menu-footer">
                                    <li> <a href="pricing.html" class="caption-1 text-variant-2">Anasayfa</a> </li>
    
                                    <li> <a href="about-us.html" class="caption-1 text-variant-2">Hakkımızda</a> </li>
    
                                    <li> <a href="contact.html" class="caption-1 text-variant-2">İletişim</a> </li>
                                </ul>
                            </div>
                      ...
                      <div class="col-lg-2 col-md-6">
                        <div class="footer-cl-3 footer-col-block">
                            <div class="fw-7 text-white footer-heading-mobile">İlanlar</div>
                            <div class="tf-collapse-content">
                                <ul class="mt-10 navigation-menu-footer">
                                    <li> <a href="topmap-list.html" class="caption-1 text-variant-2">Satılık</a> </li>
                                    <li> <a href="topmap-grid.html" class="caption-1 text-variant-2">Kiralık</a> </li>
                                    <li> <a href="topmap-grid.html" class="caption-1 text-variant-2">Projeler</a> </li>
                                </ul>
                            </div>
                      ...
                      <div class="col-lg-4 col-md-6">
                        <div class="footer-cl-4 footer-col-block">
                            <div class="fw-7 text-white footer-heading-mobile">Yeni Gelişmeler</div>
                            <div class="tf-collapse-content">
                                <p class="mt-12 text-variant-2">Yeni İlanlarımıza Hemen Ulaşın</p>
                                <form class="mt-12" id="subscribe-form" action="#" method="post" accept-charset="utf-8" data-mailchimp="true">
                                    <div id="subscribe-content">
                                        <input type="email" name="email-form" id="subscribe-email" placeholder="E-Posta"/>
                ...
                <div class="bottom-footer">
                  <div class="container">
                    <div class="content-footer-bottom">
                        <div class="copyright">2024 Private Gayrimenkul ©</div>
                    </div>
                  </div>
                </div>
            </footer>
    ...
    <script type="text/javascript" src="../interface/js/swiper-bundle.min.js"></script>
    <script type="text/javascript" src="../interface/js/carousel.js"></script>
    <script type="text/javascript" src="../interface/js/plugin.js"></script>
    <script type="text/javascript" src="../interface/js/jquery.nice-select.min.js"></script>
    <script type="text/javascript" src="../interface/js/rangle-slider.js"></script>
    <script type="text/javascript" src="../interface/js/countto.js"></script>
    <script type="text/javascript" src="../interface/js/shortcodes.js"></script>
    <script type="text/javascript" src="../interface/js/animation_heading.js"></script>
    <script type="text/javascript" src="../interface/js/lazysize.min.js"></script>
    <script type="text/javascript" src="../interface/js/main.js"></script>
  
</body>

</html><?php /**PATH C:\Users\astok\Desktop\private_real_estate\resources\views/interface/footer.blade.php ENDPATH**/ ?>