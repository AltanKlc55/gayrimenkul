...
class input extends Component
{
    ...
    public $multilang;
    public $lang;
    public function __construct($type= "",$title= "",$name= "",$entry= "",$path= "",$readonly= false,$description = "",$class = "",$required=false,$filetype="",$attribute="",$disabled=false,$grid="",$id="",$lang=false,$multilang = false)
    {
        $this->type = $type;
        $this->title = $title;
        $this->name = $name;
