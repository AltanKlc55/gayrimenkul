...
class CargoConfig
{
    ...
    public function __construct()
    {
        ...
        $this->ArasCargo = array(
            'UserName' => "neodyum",
            'Password' => "nd2580",
            'url' => "http://customerservicestest.araskargo.com.tr/arascargoservice/arascargoservice.asmx?wsdl",
        );
    ...
    public function Aras()
    {
        ...
        */
        ...
        $aras->UserName = $this->ArasCargo['UserName'];
        $aras->Password = $this->ArasCargo['Password'];
        $aras->url		= $this->ArasCargo['url'];
